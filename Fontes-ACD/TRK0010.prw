...
User Function TRK0010()
	...
	Private aColNaoOrd	:= {}
	Private cAlias		:= "SZW"
	Private cCadastro	:= "Missao da Separacao" // #" - Faturas - "
	Private c518Cli		:= ""
	Private c518Loja	:= ""
...
pergunte(cPergSX1,.F.)
MV_PAR01 := TamSX3("D3_OP")[1]                   // OP de?
MV_PAR02 := Replic("Z",TamSX3("D3_OP")[1])       //OP até?
MV_PAR03 := TamSX3("D3_LOTECTL")[1]              //Do Lote ?
MV_PAR04 := Replic("Z",TamSX3("D3_LOTECTL")[1])  //Até Lote ?
MV_PAR05 := TamSX3("D3_COD")[1]                  //Do Produto ?
MV_PAR06 := Replic("Z",TamSX3("D3_COD")[1])      //Até Produto ?
...
SetMVValue(cPergSX1, "MV_PAR01", TamSX3("D3_OP")[1]                 , .F.)
SetMVValue(cPergSX1, "MV_PAR02", Replic("Z",TamSX3("D3_OP")[1])     , .F.)
SetMVValue(cPergSX1, "MV_PAR03", TamSX3("D3_LOTECTL")[1]            , .F.)
SetMVValue(cPergSX1, "MV_PAR04", Replic("Z",TamSX3("D3_LOTECTL")[1]), .F.)
SetMVValue(cPergSX1, "MV_PAR05", TamSX3("D3_COD")[1]                , .F.)
SetMVValue(cPergSX1, "MV_PAR06", Replic("Z",TamSX3("D3_COD")[1])    , .F.)
